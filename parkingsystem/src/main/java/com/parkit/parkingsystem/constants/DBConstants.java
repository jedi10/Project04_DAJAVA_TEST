...
public class DBConstants {
    ...
    public static final String UPDATE_TICKET = "update ticket set PRICE=?, IN_TIME=? where ID=?";
    public static final String UPDATE_TICKET_ON_EXIT = "update ticket set PRICE=?, OUT_TIME=? where ID=?";
    ...
    public static final String GET_TICKET_ON_EXIT = "select t.PARKING_NUMBER, t.ID, t.PRICE, t.IN_TIME, t.OUT_TIME, p.TYPE, p.AVAILABLE from ticket t,parking p where p.parking_number = t.parking_number and t.VEHICLE_REG_NUMBER=? and t.OUT_TIME IS NULL order by t.IN_TIME DESC limit 1";
